	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201" style="text-align: left;">
						Tạo ra 1 nhà hàng với các món ăn đa dạng, giao diện quan và dễ sử dụng. Góp phần phục vụ tốt công tác phòng chống dịch covid 19 ở Việt Nam
					</p>
				</div>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Đây website cá nhân của Nguyễn Minh Kha, mọi thông tin khác vui lòng liên hệ 0911603179
					</p>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<form>
						<div class="wrap-input1 w-full p-b-4">
							<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
								khab1809242@student.ctu.edu.vn
							</a>
						</div>
					</form>
				</div>
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl7 txt-center" style="text-align: center;">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;2022 All rights reserved | Made by Nguyen Minh Kha 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
